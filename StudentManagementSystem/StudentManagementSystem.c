...
struct student  //the main variables of any student
{
	int id;              //Student ID
...
{
	struct student data;      //The Data
	struct node *next;        //Next Address
};

struct node *head =NULL; //The head of the linked list (The first one)

struct node *current =NULL; //The one that i am access on it now

int checkID(int id); //Check the Id is already in the linked list or not

void addStudent(const struct student *const ptr); /*This function collects new student details from the user and adds them to the
	student linked list.*/

void displayStudents(void); //This function displays the details of all students currently in the system.

void searchStudentByID(int id); //This function searches for a student by their ID and displays their details if found.

void updateStudent(int id); //This function updates the details of a student with the given ID.

float calculateAverageGPA(void);//This function calculates and returns ethe average GPA of all students.

void searchHighestGPA(void); //This function finds and displays the student with the highest GPA.

void deleteStudent(int id); //This function deletes a student from the linked list by their ID.
...
int checkID(int id)
{//Check the Id is already in the linked list or not
	current = head;
	while(current != NULL)
	{
